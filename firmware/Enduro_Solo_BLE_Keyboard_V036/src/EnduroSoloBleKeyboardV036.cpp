...
static const uint8_t _hidReportDescriptor[] = {
  ...
  REPORT_SIZE(1),     0x08,          //   REPORT_SIZE(8)
  LOGICAL_MINIMUM(1), 0x00,          //   LOGICAL_MINIMUM(0)
  LOGICAL_MAXIMUM(1), 0x73,          //   LOGICAL_MAXIMUM(0x73) ; hasta F24
  USAGE_PAGE(1),      0x07,          //   USAGE_PAGE (Kbrd/Keypad)
  USAGE_MINIMUM(1),   0x00,          //   USAGE_MINIMUM (0)
  USAGE_MAXIMUM(1),   0x73,          //   USAGE_MAXIMUM (0x73) ; hasta F24
...
void BleKeyboard::begin(void)
{
  ...
  // La placa no tiene pantalla ni teclado: emparejamiento "Just Works".
  // Configuracion recomendada por Espressif para Arduino ESP32 3.3.x.
